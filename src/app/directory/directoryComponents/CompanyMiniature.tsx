...
const CompanyMiniature: FC<CompanyMiniatureProps> = ({ }) => {
    return (
        <div className='flex flex-row border border-gray-50 shadow rounded-xl
        hover:bg-gray-100 hover:border-transparent my-2 p-5 text-gray-500 max-w-7xl cursor-pointer'>
            <div className='w-36 h-36 bg-cyan-900 rounded-xl'></div>
